...
/**
 * Simple test client for BruteCollinearPoints class.
...
public class BruteCollinearPointsTest {
    ...
    class LineSegmentsCheck {
        ...
        void fewerThanFourCollinearPointsTest() {
            ...
            assertCorrectLineSegments(new BruteCollinearPoints(points), correctLineSegments);
        }
     ...
     */
    static private void assertNLineSegments(BruteCollinearPoints collinearPoints, int n) {
     ...
     */
    static private void assertCorrectLineSegments(BruteCollinearPoints collinearPoints, String[][] correctLineSegments) {
